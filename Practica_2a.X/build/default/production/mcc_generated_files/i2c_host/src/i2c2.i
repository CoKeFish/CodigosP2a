...
void __attribute__((picinterrupt(("irq(I2C2), base(8)")))) I2C2_ISR(void)
{
...
void __attribute__((picinterrupt(("irq(I2C2E), base(8)")))) I2C2_ERROR_ISR(void)
{
    if (I2C2_IsBusCol())
    {
...
void __attribute__((picinterrupt(("irq(I2C2RX), base(8)")))) I2C2_RX_ISR(void)
{
    *i2c2Status.readPtr++ = I2C2_DataReceive();
}

void __attribute__((picinterrupt(("irq(I2C2TX), base(8)")))) I2C2_TX_ISR(void)
{
